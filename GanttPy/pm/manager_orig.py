...
#
# package imports
from GanttPy.dataframe.dftime import today_floor, get_next_monday
...
class ProjectManager:
    ...
    def dependencies(self, new_df):
        ...
        start, finish = dependency_mod(task, start, finish, new_df.Dependancy_Interface)
        #
        # Internal
        ...
        #
        return dependency_mod(task, start, finish, new_df.Dependancy_Internal)
    #
    def date_process(self, new_df):
        ...
        new_df["Start_Forecast"], new_df["Finish_Forecast"] = self.dependencies(new_df)
        #
        return new_df
    #
    #
...
#
#
def dependency_mod(indices, start, finish, dependancy):
    """ """
    #1/0
