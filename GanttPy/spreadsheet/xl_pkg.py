...
# package imports
from GanttPy.dataframe.dframe import DataFrame
from GanttPy.spreadsheet.pylightxl.pylightxl import(utility_address2index,
...
#
class DataFrameOps:
    __slots__ = ['_ws',  '_column', '_index', '_header']
